...
export default function Nav() {
    return (
      ...
      <ul className="flex md:flex-col md:flex-wrap">
        ...
        <li className="md:flex items-center py-1 lg:px-4"><a href="#projects" data-te-smooth-scroll-init><span className="ml-2 hover:text-rose-600 dark:hover:text-green-100 hover:italic transition duration-300 ease-in-out">Projects</span></a></li>
  </ul>
      </nav>
